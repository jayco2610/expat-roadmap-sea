            ...
            {done ? (
              ...
              >
                <input
                  ...
                  className="w-full rounded-lg border border-white/25 bg-white/10 px-4 py-3 text-white placeholder-white/50 backdrop-blur-sm focus:border-white/50 focus:outline-none sm:max-w-xs"
                />
                <button
                  type="submit"
                  className="rounded-lg bg-white px-6 py-3 text-[0.9375rem] font-medium text-[#2b2e28] transition hover:bg-white/90"
                >
                  Subscribe
                </button>
              </form>
